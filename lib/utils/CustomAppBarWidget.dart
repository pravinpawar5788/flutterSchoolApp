...
class _CustomAppBarWidgetState extends State<CustomAppBarWidget> {
  ...
  Future<String> getImageUrl(String email, String password, String rule) async {
    ...
    if (response.statusCode == 200) {
      Map<dynamic, dynamic> user = jsonDecode(response.body) as Map;
      if (rule == '2') {
  ...
  Future<int> getNotificationCount(int id) async {
    ...
    if (response.statusCode == 200) {
      Map<dynamic, dynamic> notifications = jsonDecode(response.body) as Map;
