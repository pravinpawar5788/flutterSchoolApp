...
import '../screens/student/library/EBookListScreen.dart';
...
class AppFunction {
  ...
  static void getLibraryDashboardPage(BuildContext context, String title,
    ...
    switch (title) {
      ...
      case 'Books Issued':
        ...
        break;
      case 'e-Books':
        Navigator.push(context, ScaleRoute(page: const EBookListScreen()));
        break;
    }
  }
  ...
  static void getStudentAttendanceDashboardPage(
      BuildContext context, String title,
      {var id,  String? image,  int? zoom, required String token}) {
    switch (title) {
      case 'Class Atten':
