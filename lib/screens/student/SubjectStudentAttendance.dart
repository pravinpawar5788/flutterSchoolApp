...
class SubjectStudentAttendanceScreen extends StatefulWidget {
  ...
  SubjectStudentAttendanceScreen(
      {Key? key, this.id, this.token, this.schoolId, this.subjectCode, required this.subjectName}) : super(key: key);
...
class _SubjectStudentAttendanceScreenState
  ...
  _SubjectStudentAttendanceScreenState(
      {this.id, required this.token,  this.schoolId, this.subjectCode, required this.subjectName});
