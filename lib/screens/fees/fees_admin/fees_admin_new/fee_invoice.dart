...
class _FeesInvoiceScreenState extends State<FeesInvoiceScreen> {
  late Future<FeesRecordList> fees;
  ...
  Future<FeesRecordList> getFeesInvoice() async {
    ...
    if (response.statusCode == 200) {
      ...
      invoices.addAll(
          FeesRecordList.fromJson(jsonData['studentInvoices']).feesRecords as Iterable<FeesRecord>);
      ...
      return Container(
        ...
        child: Padding(
          ...
          child: Text(
            ...
            : double.parse(feesRecord.paidAmount.toString())) != null) {
      return Container(
        width: MediaQuery.of(context).size.width,
