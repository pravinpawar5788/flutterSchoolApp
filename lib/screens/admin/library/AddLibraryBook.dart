...
class _AddAdminBookState extends State<AddAdminBook> {
  ...
  late Future<AdminSubjectList> subjectList;
  late Future<AdminCategoryList> categoryList;
      ...
      child: DropdownButton(
        ...
        onChanged: (value) {
          setState(() {
            ...
            selectedSubjectId = getCode1(subjects, value);
          });
        },
  ...
  int? getCode<T extends Iterable<Admincategory>?>(T? t, String title) {
    int? code;
    if (t != null) {
      for (var cls in t) {
        if (cls.title == title) {
  ...
  int? getCode1<T extends Iterable<AdminSubject>?>(T? t, String title) {
    int? code;
    if (t != null) {
      for (var cls in t) {
        if (cls.title == title) {
