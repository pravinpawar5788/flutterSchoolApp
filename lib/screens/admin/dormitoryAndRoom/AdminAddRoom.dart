...
class _AddRoomState extends State<AddRoom> {
      ...
      child: DropdownButton(
        ...
        onChanged: (value) {
          setState(() {
            ...
            selectedRoomId = getCode1(roomList, value);
          });
        },
        value: selectedRoom,
      ),
  ...
  int? getCode<T extends Iterable<AdminDormitory>?>(T? t, String title) {
    int? code;
    if (t != null) {
      for (var cls in t) {
        if (cls.title == title) {
  ...
  int? getCode1<T extends Iterable<AdminRoomType>?>(T? t, String title) {
    int? code;
    if (t != null) {
      for (var cls in t) {
        if (cls.title == title) {
