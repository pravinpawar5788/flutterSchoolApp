...
class DBStudentProfile extends StatefulWidget {
  ...
  DBStudentProfile({Key? key, required this.id, required this.image}) : super(key: key);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: ParentsDetailsRow(
                        title: "Phone".tr,
                        value: _studentDetails.studentData!.user!.parents!.mothersMobile ?? '',
                      ),
                    ),
                    ParentsDetailsRow(
                      title: "Occupation".tr,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: ParentsDetailsRow(
                        title: "Email".tr,
                        value: _studentDetails.studentData!.user!.parents!.guardiansEmail!,
                      ),
                    ),
                    GestureDetector(
                      onTap: () async {
                      ...
                      child: ParentsDetailsRow(
                        title: "Phone".tr,
                        value: _studentDetails.studentData!.user!.parents!.guardiansMobile!,
                      ),
                    ),
                    ParentsDetailsRow(
                      title: "Occupation".tr,
                      value: _studentDetails.studentData!.user!.parents!.guardiansOccupation!,
                    ),
                    ParentsDetailsRow(
                      title: "Relation".tr,
                      value: _studentDetails.studentData!.user!.parents!.guardiansRelation!,
                    ),
                  ],
                ),
              )
...
class ParentsDetailsRow extends StatelessWidget {
  ...
  const ParentsDetailsRow({Key? key, required this.title, required this.value}) : super(key: key);
