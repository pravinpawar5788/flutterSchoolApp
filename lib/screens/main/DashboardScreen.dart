        ...
        return _systemController.isLoading.value
          ...
          items: [
            ...
            PersistentBottomNavBarItem(
              ...
              title: "Notification".tr ?? "Notification",
              activeColorPrimary: Colors.deepPurple.withOpacity(0.9),
              inactiveColorPrimary: Colors.grey.withOpacity(0.9),
            ),
            PersistentBottomNavBarItem(
              ...
              title: widget.role == "4" ? "Attendance".tr ?? "Attendance" : "Fees".tr ?? "Fees",
              activeColorPrimary: Colors.blue.withOpacity(0.9),
              inactiveColorPrimary: Colors.grey.withOpacity(0.9),
            ),
            PersistentBottomNavBarItem(
              inactiveIcon: widget.role == "4"
              ...
              title: widget.role == "4" ? "Academic".tr ?? "Academic" : "TimeTable".tr ?? "TimeTable",
              activeColorPrimary: Colors.deepPurple.withOpacity(0.9),
              inactiveColorPrimary: Colors.grey.withOpacity(0.9),
            ),
            PersistentBottomNavBarItem(
              ...
              title: widget.role == "4" ? "Homework".tr ?? "Homework" : "Profile".tr ?? "Profile",
              activeColorPrimary: Colors.deepPurple.withOpacity(0.9),
              inactiveColorPrimary: Colors.grey.withOpacity(0.9),
            ),
          ],
