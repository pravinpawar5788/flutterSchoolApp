...
class GeneratedLocalizationsDelegate extends LocalizationsDelegate<S> {
  ...
  Locale Function(List<Locale> locales, Iterable<Locale> supported) listResolution({Locale? fallback, bool withCountry = true}) {
  ...
  Locale Function(Locale locale, Iterable<Locale> supported) resolution({Locale? fallback, bool withCountry = true}) {
